...
export const _xh_getCompanyList = (param = {}) =>KY_Post('/enterpriseInfo/publicList.do',param)//获取企业列表
export const _xh_getCompanyDetail = (param = {}) =>KY_Get('/enterpriseInfo/detail.do',param)//获取企业详情
export const _xh_getCompanyTypeList = (param = {}) =>KY_Post('/dictionary/getDictionaryList.do',param)//获取企业分类列表
export const _xh_getCompanyLocationList = (param = {}) =>KY_Get('/enterpriseInfo/position.do',param)//获取企业位置列表