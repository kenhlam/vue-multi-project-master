...
export const _expertList = (param = {}) => KY_Post('/expertinfo/list.do', param)//专家库列表
export const _expertDetail = (param = {}, config = {}) => KY_Post('/expertinfo/detail.do', param, config = {
...
// 云南科协定制
export const _ynkxLectureList = (param = {}, config = {
    headers: { "Content-Type": "application/x-www-form-urlencoded" },
}) => KY_Post('/_ynkx/lectureDataList.do', param, config)//专家库列表
export const _ynkxLectureDetail = (param = {}, config = {
    headers: { "Content-Type": "application/x-www-form-urlencoded" },
}) => KY_Post('/_ynkx/lectureDetailInit.do', param, config)//人物详情
